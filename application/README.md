...
| `REALSENSE_ROTATION` | `90` | degrees clockwise the RealSense picture is turned on the page and for the object detector (the camera sits portrait on the hand); `0` = as sent |
